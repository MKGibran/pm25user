  ...
  return (
    <div>
      ...
      <CCard style={{ marginBottom: '2%' }} className={`border-light`}>
        <CContainer>
          <h6 className={`mx-3 mt-3 mb-0`}>
            The fire safety database is here to help you protect Indonesia
          </h6>
          <CCardBody style={{ textAlign: 'center' }}>
            <CRow>
              <p style={{ textAlign: 'justify' }}>
                ...
                satellite hotspot data and air pollution measures. By signing up to this platform
                you get access to this information for your specific area and become part of our
                Clean Air Indonesia community and be eligible for local and national awards. …etc…
              </p>
            </CRow>
          </CCardBody>
        </CContainer>
            ...
            <CRow>
              ...
              <CCard style={{ marginBottom: '2%' }} className={`border-light`}>
                <CCardBody>
                  ...
                  <p>
                    Report a fire currently in progress to get support or make a record of a recent
                    fire
                  </p>
                </CCardBody>
              </CCard>
